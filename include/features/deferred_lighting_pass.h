...
// Deferred lighting: combines G-buffer data with lighting calculations
// Inputs: G-buffer, shadows, SSAO, IBL textures
// Output: Lit HDR scene color
// Supports: directional light + point lights + IBL
namespace chr {
