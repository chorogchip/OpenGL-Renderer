...
// Core graphics utilities for OpenGL rendering
// - Shader compilation and linking
// - 2D texture loading and creation (LDR, HDR)
// - Cubemap creation and mip generation
// - Cubemap face rendering (for IBL preprocessing)
namespace graphics {
