...
namespace {
    ...
    static void find_uniforms(chr::ToneMappingPass* pass) {
        pass->uniform_scene_color = graphics::get_uniform_location(pass->shader_program, "uSceneColor");
        pass->uniform_exposure = graphics::get_uniform_location(pass->shader_program, "uExposure");
        pass->uniform_enable_fxaa = graphics::get_uniform_location(pass->shader_program, "uEnableFxaa");
    }
}
...
namespace chr {
    ...
    void ToneMappingPass::render(
        ...
        graphics::set_uniform_int(uniform_scene_color, 0);
        graphics::set_uniform_float(uniform_exposure, exposure);
        graphics::set_uniform_int(uniform_enable_fxaa, enable_fxaa ? 1 : 0);
